window.groupData = {
  ...
  "generalists": {
    ...
    "builds": [
      ...
      },
      {
        ...
        "notes": [
          {"text": "Stormlash or Schaefers + Twilight + Titans Grip + Cyclopean + Gorefoot", "style": "secondary", "pill": false}
        ]
      },
      {
      ...
      {
        "buildName": "Dual Enchant Multishot",
        "className": "Sorceress",
        "tableClass": "table-sorc",
        "roles": [
          {"text": "DPS", "style": "danger"},
  ...
  "physical": {
    ...
    "descriptions": [
      ...
      "Scaling deadly strike and critical strike is crucial. Only review tooltip damage with all party buffs active!"
    ],
    "notes": [
      "NOTE! Must have summons for T4. Necro summons are not advised, low Psn res and die fast.",
      "NOTE! T4 - Very high level Amp + Battle Cry can break all except stone-skin Blood bringer in T4."
    ],
    "classBuilds": {
      "Sorceress": [
        {
      ...
      "Druid": [
        ...
        },
        {
          ...
          "notes": [
            {"text": "Quetzalcoatl for speed", "style": "secondary"}
          ],
          "links": []
        },
        {
          "buildName": "Summon (Dual Spirit)",
          "tier": "Top",
          "roles": [
            {"text": "T4", "style": "dark"},
            {"text": "Summon Wall", "style": "secondary"},
      ...
      "Assassin": [
        ...
        {"buildName": "Dragon Tail (Fire Kick) Demon Machine", "tier": "Good", "roles": [{"text": "DPS", "style": "danger"}], "notes": [{"text": "20 hard pts into Blade shield for more procs", "style": "secondary"}], "links": []},
        {"buildName": "Dragon Tail (Fire Kick) Astreons", "tier": "Top", "roles": [{"text": "DPS", "style": "danger"}], "notes": [], "links": []},
        {"buildName": "Blade Fury (Demon Machine)", "tier": "Decent", "roles": [{"text": "DPS", "style": "danger"}], "notes": [], "links": []},
        ...
        {"buildName": "Physical Blade Dance (Chaos - Phys Dmg Focus)", "tier": "Good", "roles": [{"text": "DPS", "style": "danger"}], "notes": [], "links": []},
      ...
      "Barbarian": [
        {"buildName": "Whirlwind (2-H)", "tier": "Top", "roles": [{"text": "DPS", "style": "danger"}], "notes": [{"text": "Must use 4 range adder weapon", "style": "secondary"}], "links": []},
        ...
        {"buildName": "Double Throw (Physical)", "tier": "Top", "roles": [{"text": "T4", "style": "dark"}, {"text": "DPS", "style": "danger"}], "notes": [{"text": "Deep wounds does not scale in party play", "style": "secondary"}], "links": []},
      ...
      "Amazon": [
        ...
        {"buildName": "Multiple Shot", "tier": "Decent", "roles": [{"text": "DPS", "style": "danger"}], "notes": [], "links": []},
        {"buildName": "Multiple Shot (Demon Machine)", "tier": "Good", "roles": [{"text": "DPS", "style": "danger"}], "notes": [], "links": []},
        {"buildName": "Strafe Demon Machine Summon Hybrid", "tier": "Top", "roles": [{"text": "T4", "style": "dark"}, {"text": "DPS", "style": "danger"}], "notes": [], "links": []},
      ...
      "Necromancer": [
        {"buildName": "Skele Summon + No Innocence on merc", "tier": "Good", "roles": [{"text": "DPS", "style": "danger"}, {"text": "Summon Wall", "style": "secondary"}], "notes": [{"text": "Aggressive bloodwarps = more DPS", "style": "secondary"}], "links": []},
  ...
  "elemental": {
    ...
    "notes": [
      "NOTE! Must be tri-elemental damage across the team and have summons for T4. Necro summons are not advised, low Psn res and die fast.",
      "NOTE! T4 - Very high Lower Res + Conviction + Inferno/Static/Artic blast can break immunities but the damage is still typically too low, it is better to have 3 elements and not over stack one element."
    ],
    "classBuilds": {
      "Sorceress": [
        ...
        {"buildName": "Hydra", "tier": "Good", "roles": [{"text": "T4", "style": "dark"}, {"text": "DPS", "style": "danger"}], "notes": [{"text": "Hydras double dip Res auras", "style": "secondary"}], "links": []},
      ...
      "Druid": [
        ...
        {"buildName": "Poison Creeper (Worm Re-Summoning)", "tier": "Bad", "roles": [{"text": "DPS", "style": "danger"}, {"text": "Worms", "style": "success"}], "notes": [{"text": "Psn scaling bad in groups", "style": "secondary"}, {"text": "Sustain worms", "style": "secondary"}], "links": []}
      ],
      "Assassin": [
        {"buildName": "Chain Lightning Sentry", "tier": "Good", "roles": [{"text": "T4", "style": "dark"}, {"text": "DPS", "style": "danger"}], "notes": [{"text": "Traps can't keep group pace", "style": "secondary"}], "links": []},
        {"buildName": "Wake of Fire", "tier": "Good", "roles": [{"text": "T4", "style": "dark"}, {"text": "DPS", "style": "danger"}], "notes": [{"text": "Traps can't keep group pace", "style": "secondary"}], "links": []},
      ...
      "Barbarian": [
        ...
        {"buildName": "Ele Proc Leap Attack", "tier": "Mid", "roles": [{"text": "T4", "style": "dark"}, {"text": "DPS", "style": "danger"}], "notes": [{"text": "Destruction / Stormspire / Rapture + Innocence + % Large Charms", "style": "secondary"}], "links": []},
      ...
      "Amazon": [
        ...
        {"buildName": "Cold Arrow", "tier": "Good", "roles": [{"text": "T4", "style": "dark"}, {"text": "DPS", "style": "danger"}], "notes": [{"text": "Res auras scale damage a lot", "style": "secondary"}], "links": []},
        {"buildName": "Fire Arrow", "tier": "Good", "roles": [{"text": "T4", "style": "dark"}, {"text": "DPS", "style": "danger"}], "notes": [{"text": "Res auras scale damage a lot", "style": "secondary"}], "links": []},
      ...
      "Paladin": [
        ...
        {"buildName": "Holy Shock Sac", "tier": "Good", "roles": [{"text": "DPS", "style": "danger"}], "notes": [], "links": []},
